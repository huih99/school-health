<template>
    <div class="articlePage">
        <!-- <div v-if="article.wzbt" style="font-size: 22px;font-weight: bold;line-height: 24px;text-align: center;margin:5px;">{{article.wzbt}}</div> -->
        <!-- <div v-if="article.qyrq" style="font-size: 12px;color:#B3B3B3;text-align: center;">{{article.qyrq?article.qyrq.split(' ')[0]:''}}</div> -->
      ...
      this.api.getActicleDetail(params).then(
          res => {
            ...
            if (data.length) {
              ...
              this.api.getHtml(url, {}).then((res1)=>{　
                data.nr = res1;
